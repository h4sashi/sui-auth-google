...
export type ExecuteTransactionResult = RpcClientExecuteTransactionResult | GraphQLClientExecuteTransactionResult;
export type ExecuteTransactionOptions = {
    execute?: (signedTransaction: SignedTransaction) => Promise<ExecuteTransactionResult>;
};
