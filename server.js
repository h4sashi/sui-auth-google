...
app.post("/auth/browser-wallet", async (req, res) => {
  console.log("🔗 Enhanced browser wallet connection request received");
  ...
  try {
    ...
    console.log(`🔗 Wallet connecting: ${walletName || 'Unknown'} (${walletType}) - ${walletAddress}`);
    ...
    try {
      ...
      console.log(`✅ Enhanced blockchain info:`, blockchainInfo);
    ...
    if (existingProfile) {
      ...
      console.log("✅ Existing user profile updated with enhanced data");
    } else {
      console.log("🆕 Creating new user profile with enhanced data");
      ...
      isNewUser = true;
      console.log("✅ New user profile created with enhanced data:", finalProfile.id);
    }
    ...
    console.log("✅ Enhanced session stored with state:", state);
    ...
    console.log("✅ Sending enhanced success response");
    res.json(responseData);

  } catch (err) {
    console.error("❌ Enhanced browser wallet connection error:", err);
    res.status(500).json({
      success: false,
...
app.post("/validate-wallet", async (req, res) => {
  console.log("🔍 Enhanced wallet validation request received");
  ...
  try {
    ...
    console.log(`🔍 Validating address: ${cleanAddress} (${walletType})`);
